...
#define FFMPEG_CONFIGURATION "--cc=/Applications/Xcode_14.2.app/Contents/Developer/usr/bin/gcc --cxx=/Applications/Xcode_14.2.app/Contents/Developer/usr/bin/g++ --ar=/usr/bin/ar --ranlib=/usr/bin/ranlib --optflags= --disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-avutil --enable-bsfs --enable-gpl --enable-static"
