...
#define FFMPEG_CONFIGURATION "--cc=/usr/bin/cc --cxx=/usr/bin/c++ --ar=/usr/bin/ar --ranlib=/usr/bin/ranlib --optflags= --disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-avutil --enable-bsfs --enable-gpl --enable-static"
