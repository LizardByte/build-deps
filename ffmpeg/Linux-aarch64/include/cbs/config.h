...
#define FFMPEG_CONFIGURATION "--cc=/usr/bin/aarch64-linux-gnu-gcc --cxx=/usr/bin/aarch64-linux-gnu-g++ --ar=/usr/bin/aarch64-linux-gnu-ar --ranlib=/usr/bin/aarch64-linux-gnu-ranlib --optflags= --disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-avutil --enable-bsfs --enable-gpl --enable-static --arch=aarch64 --enable-cross-compile"
