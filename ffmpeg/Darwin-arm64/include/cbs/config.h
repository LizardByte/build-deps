...
#define FFMPEG_CONFIGURATION "--cc=/usr/bin/clang --cxx=/usr/bin/clang++ --ar=/usr/bin/ar --ranlib=/usr/bin/ranlib --optflags='-arch arm64 -target arm64-apple-macosx -march=armv8-a+crc+crypto -mcpu=generic' --disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-avutil --enable-bsfs --enable-gpl --enable-static --arch=arm64 --enable-cross-compile"
