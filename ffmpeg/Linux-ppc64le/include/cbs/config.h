...
#define FFMPEG_CONFIGURATION "--cc=/usr/bin/powerpc64le-linux-gnu-gcc --cxx=/usr/bin/powerpc64le-linux-gnu-g++ --ar=/usr/bin/powerpc64le-linux-gnu-ar --ranlib=/usr/bin/powerpc64le-linux-gnu-ranlib --optflags= --disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-avutil --enable-bsfs --enable-gpl --enable-static --arch=ppc64le --enable-cross-compile"
