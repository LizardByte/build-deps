...
#define FFMPEG_CONFIGURATION "--prefix=/home/runner/work/build-deps/build-deps/build/FFmpeg --pkg-config=/bin/pkg-config --extra-cflags=' -w' --extra-cxxflags=' -w' --cc=/usr/bin/powerpc64le-linux-gnu-gcc-12 --cxx=/usr/bin/powerpc64le-linux-gnu-g++-12 --ar=/usr/bin/powerpc64le-linux-gnu-ar --ranlib=/usr/bin/powerpc64le-linux-gnu-ranlib --pkg-config-flags=--static --extra-cflags=-I/home/runner/work/build-deps/build-deps/build/usr/local/include --extra-cflags=-I/home/runner/work/build-deps/build-deps/build/x264/include --extra-cflags=-I/home/runner/work/build-deps/build-deps/build/libva/include --extra-ldflags=-L/home/runner/work/build-deps/build-deps/build/usr/local/lib --extra-ldflags=-L/home/runner/work/build-deps/build-deps/build/x264/lib --extra-ldflags=-L/home/runner/work/build-deps/build-deps/build/libva/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-amf --enable-encoder='h264_amf,hevc_amf,av1_amf' --enable-cuda --enable-encoder='h264_nvenc,hevc_nvenc,av1_nvenc' --enable-ffnvcodec --enable-nvenc --enable-cuda_llvm --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-vaapi --enable-encoder='h264_vaapi,hevc_vaapi,av1_vaapi' --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-encoder=h264_v4l2m2m --enable-v4l2_m2m --arch=ppc64le --enable-cross-compile --target-os=linux --cross-prefix=/usr/bin/powerpc64le-linux-gnu-"
