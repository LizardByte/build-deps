...
#define FFMPEG_CONFIGURATION "--prefix=/d/a/build-deps/build-deps/build/FFmpeg --pkg-config=/d/a/_temp/msys64/usr/bin/pkg-config.exe --extra-cflags=' -w' --extra-cxxflags=' -w' --cc='D:/a/_temp/msys64/ucrt64/bin/cc.exe' --cxx='D:/a/_temp/msys64/ucrt64/bin/c++.exe' --ar='D:/a/_temp/msys64/ucrt64/bin/ar.exe' --ranlib='D:/a/_temp/msys64/ucrt64/bin/ranlib.exe' --pkg-config-flags=--static --extra-cflags=-I/d/a/build-deps/build-deps/build/usr/local/include --extra-cflags=-I/d/a/build-deps/build-deps/build/x264/include --extra-cflags=-I/d/a/build-deps/build-deps/build/libva/include --extra-ldflags=-L/d/a/build-deps/build-deps/build/usr/local/lib --extra-ldflags=-L/d/a/build-deps/build-deps/build/x264/lib --extra-ldflags=-L/d/a/build-deps/build-deps/build/libva/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-amf --enable-encoder='h264_amf,hevc_amf,av1_amf' --enable-encoder='h264_mf,hevc_mf,av1_mf' --enable-mediafoundation --enable-cuda --enable-encoder='h264_nvenc,hevc_nvenc,av1_nvenc' --enable-ffnvcodec --enable-nvenc --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-d3d11va --enable-encoder='h264_qsv,hevc_qsv,av1_qsv' --enable-libvpl"
...
#define CC_IDENT "gcc 15.2.0 (Rev11, Built by MSYS2 project)"
...
#define HAVE_STRUCT_MFXCONFIGINTERFACE 1
#define HAVE_GZIP 1
