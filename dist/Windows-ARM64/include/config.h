...
#define FFMPEG_CONFIGURATION "--prefix=/c/a/build-deps/build-deps/build/FFmpeg --pkg-config=/c/a/_temp/msys64/usr/bin/pkg-config.exe --extra-cflags=' -w' --extra-cxxflags=' -w' --cc='C:/a/_temp/msys64/clangarm64/bin/cc.exe' --cxx='C:/a/_temp/msys64/clangarm64/bin/c++.exe' --ar='C:/a/_temp/msys64/clangarm64/bin/llvm-ar.exe' --ranlib='C:/a/_temp/msys64/clangarm64/bin/llvm-ranlib.exe' --pkg-config-flags=--static --extra-cflags=-I/c/a/build-deps/build-deps/build/usr/local/include --extra-cflags=-I/c/a/build-deps/build-deps/build/x264/include --extra-cflags=-I/c/a/build-deps/build-deps/build/libva/include --extra-ldflags=-L/c/a/build-deps/build-deps/build/usr/local/lib --extra-ldflags=-L/c/a/build-deps/build-deps/build/x264/lib --extra-ldflags=-L/c/a/build-deps/build-deps/build/libva/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-amf --enable-encoder='h264_amf,hevc_amf,av1_amf' --enable-encoder='h264_mf,hevc_mf,av1_mf' --enable-mediafoundation --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-d3d11va --enable-encoder='h264_qsv,hevc_qsv,av1_qsv' --enable-libvpl"
...
#define CC_IDENT "clang version 21.1.8"
