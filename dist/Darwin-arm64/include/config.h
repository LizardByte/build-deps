...
#define FFMPEG_CONFIGURATION "--prefix=/Users/runner/work/build-deps/build-deps/build/FFmpeg --pkg-config=/opt/homebrew/bin/pkg-config --extra-cflags=' -w' --extra-cxxflags=' -w' --cc=/usr/bin/clang --cxx=/usr/bin/clang++ --ar=/usr/bin/ar --ranlib=/usr/bin/ranlib --pkg-config-flags=--static --extra-cflags=-I/Users/runner/work/build-deps/build-deps/build/usr/local/include --extra-cflags=-I/Users/runner/work/build-deps/build-deps/build/x264/include --extra-cflags=-I/Users/runner/work/build-deps/build-deps/build/libva/include --extra-ldflags=-L/Users/runner/work/build-deps/build-deps/build/usr/local/lib --extra-ldflags=-L/Users/runner/work/build-deps/build-deps/build/x264/lib --extra-ldflags=-L/Users/runner/work/build-deps/build-deps/build/libva/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-encoder='h264_videotoolbox,hevc_videotoolbox' --enable-videotoolbox --arch=arm64 --enable-cross-compile --target-os=darwin"
